...
void LevelB::initialise()
{
    ...
    std::unordered_set<unsigned int> solidTiles = { 10 };
    ...
    HazardSpec specs[HAZARD_COUNT] = {
        // LEFT column
        { "assets/game/job.png",       3.0f,  6.5f, 0 }, // bob
        // MIDDLE
        { "assets/game/job.png",      12.0f,  6.5f, 1 }, // sweep
        { "assets/game/leetcode.png", 20.0f,  6.5f, 2 }, // orbit
        // BOTTOM row
        { "assets/game/job.png",       5.0f, 11.0f, 0 }, // bob
        { "assets/game/job.png",      15.0f, 11.0f, 1 }, // sweep
    };
    ...
    mGameState.enemies[HAZARD_COUNT] = new Entity(
        { mapLeft + 20.0f * TILE_DIMENSION, mapTop + 2.5f * TILE_DIMENSION },
        { TILE_DIMENSION, TILE_DIMENSION },
...
void LevelB::update(float deltaTime)
{
    ...
    // Walking onto trash decor (tiles 24, 29, 30) costs cortisol. The tiles
    // aren't solid — we probe the collider centre, so the player has to
    // actually stand on the trash (not just brush past it).
